    ...
    public OpenAPI openAPI() {
        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("""
                                API сервиса управления заявками KATM Platform.
                                
                                Сервис обеспечивает регистрацию, верификацию и управление заявками финансовой платформы.
